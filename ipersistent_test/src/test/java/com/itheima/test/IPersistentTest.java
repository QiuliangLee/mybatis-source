...
public class IPersistentTest {
    ...
    public void test1() throws Exception {
        ...
        User user2 = sqlSession.selectOne("com.itheima.dao.IUserDao.findAll", user);

        System.out.println(user2);
        List<User> list = sqlSession.selectList("com.itheima.dao.IUserDao.selectList.findAll", null);
        for (User user1 : list) {
